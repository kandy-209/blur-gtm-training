...
# Core Cache Tests
Write-Host ""
Write-Host "CORE CACHE TESTS" -ForegroundColor Magenta
...
Write-Host ""
Write-Host "API INTEGRATION TESTS" -ForegroundColor Magenta
...
# API Route Tests
Write-Host ""
Write-Host "API ROUTE TESTS" -ForegroundColor Magenta
